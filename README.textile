...
so if you don't have it the first step is to go to http://www.greasespot.net/
and install it.

After Grasemonkey installed, just go to http://www.mamata.com.br/greasemonkey/
and click on the link for this script on the list.
...
Check the video at http://vimeo.com/2344689